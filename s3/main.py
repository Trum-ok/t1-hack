...
if __name__ == "__main__":
    ...
    s3_client.create_bucket("new-bucket")
    print(s3_client.bucket_exists("new-bucket"))
    s3_client.upload_file('new-bucket', 'faiss/test.json', 'test.json')
    print(s3_client.list_objects('new-bucket'))
